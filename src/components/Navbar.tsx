                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-8">
                                <Link href="/" className="text-white hover:text-gold transition-colors px-3 py-2 rounded-md text-sm font-medium">
                                    Home
                                </Link>
                                ...
                                <button
                                    ...
                                    className="bg-gold text-black px-6 py-2 rounded-full font-medium hover:bg-gold-light transition-colors"
                                >
                                    Book Now
                                </button>
                            </div>
                ...
                {isOpen && (
                    <div className="md:hidden bg-black border-b border-white/10">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                            <Link href="/" className="text-white hover:text-gold block px-3 py-2 rounded-md text-base font-medium">
                                Home
                            </Link>
                            ...
                            <button
                                ...
                                className="w-full text-left block bg-gold text-black px-3 py-2 rounded-md text-base font-medium hover:bg-gold-light mt-4"
                            >
                                Book Now
                            </button>
                        </div>
